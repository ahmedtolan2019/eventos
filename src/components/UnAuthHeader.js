...
export const UnAuthHeader = () => {
  ...
  return (
    <div className=" relative flex flex-row py-4 z-30  justify-between text-gray-800">
      ...
      {open && (
        <ul className="sm:hidden absolute top-14 w-full gap-4 mx-auto bg-gray-100 h-40 rounded p-2 shadow-lg flex flex-col  items-center  font-normal text-xl lg:text-2xl">
          <li className="hover:text-gray-500 bg-white h-16 items-center border  rounded  shadow-lg flex justify-center w-full text-center cursor-pointer">
